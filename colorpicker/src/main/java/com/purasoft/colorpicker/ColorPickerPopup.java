...
public class ColorPickerPopup {
    ...
    public void show(View parent, final ColorPickerObserver observer) {
        ...
        TextView tv_defaultColor = layout.findViewById(R.id.default_color);
        tv_defaultColor.setText(defaultTitle);
        tv_defaultColor.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                popupWindow.dismiss();
                if (observer != null) {
                    observer.onColorPicked(defaultColor);
                }
            }
        });
